...
- Update version (`python -m dev set-version 0.41.1`).
...
- Create a tag (`git tag robotframework-lsp-0.41.1`) and push it.

- Send release msg. i.e.:

Hi @channel, `Robot Framework Language Server 0.41.1` is now available.
